...
//
//  this class is totally from
//  https://www.invasivecode.com/weblog/network-reachability-in-swift/?doing_wp_cron=1484141520.9005560874938964843750
//
//
...
internal class Reachability: NSObject {
    ...
    static let shared = Reachability.networkReachabilityForInternetConnection()
    
    //private let ReachabilityDidChangeNotificationName = "ReachabilityDidChangeNotification"
