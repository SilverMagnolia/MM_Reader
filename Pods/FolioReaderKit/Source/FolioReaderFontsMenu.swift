...
public enum FolioReaderFont: Int {
	...
	public static func folioReaderFont(fontName: String) -> FolioReaderFont? {
		...
		switch fontName {
		case "gothic"		: font = .gothic
		case "myeongjo"			: font = .myeongjo
		case "pen"			: font = .pen
		case "square"		: font = .square
		default 			: break
		}
		return font
	}
...
class FolioReaderFontsMenu: UIViewController, SMSegmentViewDelegate, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        fontName.tag = 2
        fontName.addSegmentWithTitle("고딕", onSelectionImage: nil, offSelectionImage: nil)
        fontName.addSegmentWithTitle("명조", onSelectionImage: nil, offSelectionImage: nil)
        fontName.addSegmentWithTitle("펜", onSelectionImage: nil, offSelectionImage: nil)
        fontName.addSegmentWithTitle("스퀘어", onSelectionImage: nil, offSelectionImage: nil)
        fontName.segments[0].titleFont = UIFont(name: "NanumBarunGothicOTF", size: 18)!
        fontName.segments[1].titleFont = UIFont(name: "NanumMyeongjoOTF", size: 18)!
        fontName.segments[2].titleFont = UIFont(name: "NanumBarunpen", size: 18)!
        fontName.segments[3].titleFont = UIFont(name: "NanumSquareOTFR", size: 18)!
