...
open class FolioReaderConfig: NSObject {
	...
	*/
    ...
    open var localizedHighlightsTitle = NSLocalizedString("하이라이트", comment: "")
   
    /// Localizes Content title
    open var localizedContentsTitle = NSLocalizedString("목차", comment: "")
    ...
    open var localizedHighlightMenu = NSLocalizedString("하이라이트", comment: "")
    open var localizedDefineMenu = NSLocalizedString("사전", comment: "")
    open var localizedPlayMenu = NSLocalizedString("Play", comment: "")
    open var localizedPauseMenu = NSLocalizedString("Pause", comment: "")
    open var localizedFontMenuNight = NSLocalizedString("야간모드", comment: "")
    open var localizedPlayerMenuStyle = NSLocalizedString("Style", comment: "")
    open var localizedFontMenuDay = NSLocalizedString("낮모드", comment: "")
    open var localizedLayoutHorizontal = NSLocalizedString("슬라이드", comment: "")
    open var localizedLayoutVertical = NSLocalizedString("스크롤", comment: "")
